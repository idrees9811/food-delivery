        ...
        <header className='fixed z-50 w-screen  p-3 px-8 md:p-6 md:px-16 bg-primary'>
            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                <Link to={"/"} className='flex items-center gap-2'>
                    ...
                    <p className='text-headingColor text-xl font-bold'>H Dot</p>
                </Link>
                ...
                <div className='flex items-center gap-8'>
                    ...
                    <div className='relative'>
                        <motion.img
                            whileTap={{ scale: 0.6 }}
                            src={user ? user.photoURL : Avatar} className="w-10 min-w-[40px] h-10 min-h-[40px] shadow-2xl cursor-pointer rounded-full"
                            alt="userProfile"
                            onClick={login}
                        />
                        {
                            isMenu && (
                                <motion.div
                                    ...
                                    className='w-40 bg-gray-50 shadow-xl rounded-lg flex-col absolute
                                        top-12 right-0'>
                                    {
                                        user && user.email === "idreeskhan660@gmail.com" && (
                                            <Link to={'/createItem'}>
                    ...
                    />
                    {
                        isMenu && (
                            ...
                            transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2'
                                ...
                                <p className='m-2 p-2 rounded-md shadow-md flex items-center justify-center gap-3 bg-gray-200 cursor-pointer hover:bg-slate-300
